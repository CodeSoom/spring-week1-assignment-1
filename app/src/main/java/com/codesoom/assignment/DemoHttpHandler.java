...
// 3.Create => 완료
// 4.Update => 완료
// 5.Delete - collection => 완료
// 6.Delete - item/element => 완료
...
public class DemoHttpHandler implements HttpHandler {
    ...
    private void handleCollection(HttpExchange exchange ,String method)
        ...
        if (method.equals("DELETE")) {
            handleCollectionDelete(exchange);
        }

    }

    private void handleCollectionDelete(HttpExchange exchange) throws IOException {
        tasks.clear();
        send(exchange,200,"");
    }
